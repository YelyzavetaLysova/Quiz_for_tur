# Mobile Hiking Trail App

A mobile web application that simulates a hiking trail app with badges, leaderboards, and family profiles. This application is designed to be viewed on desktop but has a mobile-like appearance.

## Features

- Home screen with family information and next hike options
- Interactive map screen with trail visualization
- Trail history and detailed trail information
- AR (Augmented Reality) view simulation with quest information
- Rewards and badges system with leaderboard
